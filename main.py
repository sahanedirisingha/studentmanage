...
print("hello igenuma education ")

class  Student:
    def __init__(self,root):
        self.root=root
        #METHANA THIBBE STUDENT DATABASE MANAGEMENT SYSTEM KIYALA
        self.root.title("IGENUMA EDUCATION BY KUMARI BANDARA ")
...
#================================================================================
        ...
        self.lblTit =Label(TitFrame,font=('arial',47,'bold'),text="!!! HELLO KUMARI BANDARA !!!",bg='Ghost white')
        self.lblTit.grid()
#==========================================================================================
#monwa hri case ekak unoth balanda one sinhala akuru nisada kiyala
 ...
 #============================label and entery widgets===============
        ...
        self.lblDoB = Label(DataFrameLEFT, font=("arial", 20, "bold"), text="year:", padx=2, pady=3,bg="Ghost White")
        self.lblDoB.grid(row=3, column=0, sticky=W)
        self.txtDoB = Entry(DataFrameLEFT, font=('arial', 20, 'bold'), textvariable=Dob, width=39)
        self.txtDoB.grid(row=3, column=1)

        self.lblAge = Label(DataFrameLEFT, font=("arial", 20, "bold"), text="class:", padx=2, pady=3,bg="Ghost White")
